...
public class LocalTokenCache implements TokenCache {
    ...
    private static final Log log = LogFactory.getLog(LocalTokenCache.class);

    private static LocalTokenCache instance = null;
